...
;  ndim = n_elements(size(vis2data,/dim))
...
for i_a=0,n_elements(uniq_arrname)-1 do begin
 for j_a=0,n_elements(uniq_insname)-1 do begin
  ...
  fxbaddcol,gcol,newhead_oit3, dindgen(nwave), 'T3PHI', tunit = 'deg'
  fxbaddcol,hcol,newhead_oit3, dindgen(nwave), 'T3PHIERR', tunit = 'deg'
