...
pro gpi_pol_double_diff_onewav,cubeinfo_file,target_tsizes,nbootstrap=nbootstrap,average_together=average_together,root_dir=root_dir,save_name=save_name,wav=wav
...
if not keyword_set(wav) then wav=0
...
for tsize_ix=0,n_elements(target_tsizes)-1 do begin
    ...
    ;; Remove the wavelength dimension
    if (size(v20_0))[0] eq 3 then begin
        v20_0=v20_0[*,*,wav]
        v20_45=v20_45[*,*,wav]
        v222_0=v222_0[*,*,wav]
        v222_45=v222_45[*,*,wav]
    ...
    samples0 =fix(n0*randomu(seed1,n0,nbootstrap))
