...
;bw = 70 ;;This setting is useful for Lp L27 observations, which have a really bright ghost near the edge of the detector that confuses the centering algorithm
...
;  if (keyword_set(destripe) eq 1) then begin
  ...
  if (plotall gt 0) then begin
     ...
     al_legend,['File '+string(speck,format="(I4.4)")+"  Frame "+string(i)]
